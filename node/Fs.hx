...
extern class Fs{
  static function __init__():Void{
    ...
    untyped __js__("node.Fs.FSWatcherEvent = {Change: 'change', Error: 'error'}");
...
extern class ReadStream extends EventEmitter<String>, implements node.ReadableStream{
...
@:native('node.Fs.FSWatcherEvent')
enum FSWatcherEvent<T>{
  Change;
  Error;
  C(v:T);
}
...
extern class FSWatcher<T> extends EventEmitter<FSWatcherEvent<T>>{
